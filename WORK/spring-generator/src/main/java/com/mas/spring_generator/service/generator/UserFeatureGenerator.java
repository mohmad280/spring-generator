...
public class UserFeatureGenerator {
    ...
    // مع ال ERD
    public void addUserFeatureWithERD(ZipOutputStream zip, ProjectRequestWithERD request) throws IOException {
        String packagePath = request.getPackageName().replace(".", "/");
        String basePath = request.getProjectName() + "/src/main/java/" + packagePath;

        zipHelper.addFile(zip, basePath + "/entity/User.java", generateUserEntityWithERD(request));
        zipHelper.addFile(zip, basePath + "/repository/UserRepository.java", generateUserRepositoryWithERD(request));
        zipHelper.addFile(zip, basePath + "/dto/UserDto.java", generateUserDtoWithERD(request));
        zipHelper.addFile(zip, basePath + "/service/UserService.java", generateUserServiceWithERD(request));
        zipHelper.addFile(zip, basePath + "/service/impl/UserServiceImpl.java", generateUserServiceImplWithERD(request));
        zipHelper.addFile(zip, basePath + "/controller/UserController.java", generateUserControllerWithERD(request));
    }

    public String generateUserEntityWithERD(ProjectRequestWithERD request) {
        String roleField = "";
    ...
    public String generateUserRepositoryWithERD(ProjectRequestWithERD request) {
        return """
                package %s.repository;
    ...
    public String generateUserDtoWithERD(ProjectRequestWithERD request) {
        String roleImport = request.isRoleFeature()
                ? "import " + request.getPackageName() + ".enums.Role;\n"
                : "";
    ...
    public String generateUserServiceWithERD(ProjectRequestWithERD request) {
        return """
                package %s.service;
    ...
    public String generateUserServiceImplWithERD(ProjectRequestWithERD request) {
    ...
    private String generateUserControllerWithERD(ProjectRequestWithERD request) {
        return """
                package %s.controller;
