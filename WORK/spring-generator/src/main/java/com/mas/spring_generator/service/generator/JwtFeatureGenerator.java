...
public class JwtFeatureGenerator {
    ...
    // مع ال ERD
    public void addJwtFeatureWithERD(ZipOutputStream zip, ProjectRequestWithERD request) throws IOException {
        String packagePath = request.getPackageName().replace(".", "/");
        String basePath = request.getProjectName() + "/src/main/java/" + packagePath;

        zipHelper.addFile(zip, basePath + "/service/JwtService.java", generateJwtServiceWithERD(request));
        zipHelper.addFile(zip, basePath + "/service/CustomUserDetailsService.java", generateCustomUserDetailsServiceWithERD(request));
        zipHelper.addFile(zip, basePath + "/config/JwtAuthenticationFilter.java", generateJwtAuthenticationFilterWithERD(request));

        zipHelper.addFile(zip, basePath + "/dto/LoginRequest.java", generateLoginRequestWithERD(request));
        zipHelper.addFile(zip, basePath + "/dto/RegisterRequest.java", generateRegisterRequestWithERD(request));
        zipHelper.addFile(zip, basePath + "/dto/AuthResponse.java", generateAuthResponseWithERD(request));
        zipHelper.addFile(zip, basePath + "/controller/AuthController.java", generateAuthControllerWithERD(request));
    }

    public String generateJwtServiceWithERD(ProjectRequestWithERD request) {
        return """
                package %s.service;
    ...
    public String generateCustomUserDetailsServiceWithERD(ProjectRequestWithERD request) {
        return """
                package %s.service;
    ...
    public String generateJwtAuthenticationFilterWithERD(ProjectRequestWithERD request) {
        return """
                package %s.config;
    ...
    public String generateLoginRequestWithERD(ProjectRequestWithERD request) {
        return """
                package %s.dto;
    ...
    public String generateRegisterRequestWithERD(ProjectRequestWithERD request) {
        return """
                package %s.dto;
    ...
    public String generateAuthResponseWithERD(ProjectRequestWithERD request) {
        return """
                package %s.dto;
    ...
    public String generateAuthControllerWithERD(ProjectRequestWithERD request) {
